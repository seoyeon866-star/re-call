...
const CATEGORY_RULES: { category: string; keywords: string[] }[] = [
  ...
  { category: '뷰티헬스', keywords: ['화장품', '크림', '로션', '향수', '립스틱', '마스크팩', '에센스', '선크림', '자외선', '바디', '샴푸', '클렌징', '화장', '메이크업', '아이섀도', '파운데이션', '비비', '마스카라', '립', '토너', '미스트', '세럼', '팩', '스킨케어', '기초', '헤어', '뷰티', '헬스', '마사지', '네일', '아이라이너'] },
  ...
  { category: '가전디지털', keywords: ['보조배터리', '충전기', '배터리', '전원', 'USB', '케이블', '이어폰', '헤드폰', '어댑터', '전기', 'LED', '램프', '조명', '선풍기', '히터', '가습기', '공기청정기', '드라이기', '면도기', '전기장판', '온수기', '전자레인지', '믹서기', '블렌더', '전자', '충전', '어댑터', '파워뱅크', '배터리팩', '스피커', '마우스', '키보드', '모니터', '노트북', '스마트폰', '태블릿', 'power bank', 'smartwatch', 'wireless'] },
];
